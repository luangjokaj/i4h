				...
				<Content>
					<main>
						...
						<div className="aboutPage">
							...
							<p>The project will be kept up to date and new features will be added along the way. Check out the code and help out with suggestions or contributions.</p>

							<a href="https://github.com/luangjokaj/i4h" target="_blank" className="github"><GitHub /> <span>GitHub</span></a>
						</div>
					</main>
				</Content>
			</AppearAfter>
