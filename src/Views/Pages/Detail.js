		...
		if (doc) {
			return (
				<div className="page-wrapper">
					<Helmet>
						<title>
							{doc.data.title && PrismicReact.RichText.asText(doc.data.title)} • Interfaces 4 Humans
						</title>
					</Helmet>
						...
						<Content>
							...
							>
								<div className="tools">
									...
									<div>
										{doc.data.livelink.url && (
											<AppearAfter delay={800} className="button">
												<a href={doc.data.livelink.url} target="_blank" className="button">
													Live
													<span>
														<Preview />
													</span>
										...
										{doc.data.sourcelink.url && (
											<AppearAfter delay={900} className="button">
												<a href={doc.data.sourcelink.url} target="_blank" className="button">
													Source
													<span>
														<Link />
													</span>
							...
							{doc.data.author.uid && (
								<Designers authorUID={doc.data.author.uid} prismicCtx={this.props.prismicCtx} />
							)}
						</Content>
					</AppearAfter>
				</div>
